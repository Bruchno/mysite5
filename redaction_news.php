...
?>
<div id = "galery">
<form action = "redaction_news.php" class = "formregistration" method = "post" enctype = "multipart/form-data">
<p><input type = "file" name = "f" /></p>
<input type ="submit" name = "loadding"  value="Додати фото" />
</form></div>
<div id = "blokfoto" ><?php viewfoto1(); ?></div>
<form action = "newsview.php" accept-charset="utf8" class = "formregistration" method = "post" name = "news">
